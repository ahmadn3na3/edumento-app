...
public class AuthenticateController {
  ...
  public ResponseEntity<JWTToken> authorize(@Valid @RequestBody LoginModel loginVM) {
    ...
    long validityLen =
        loginVM.rememberMe() ? tokenValidityInSecondsForRememberMe : tokenValidityInSeconds;

    var cookie =
        org.springframework.http.ResponseCookie.from("access_token", jwt)
            .httpOnly(true)
