...
public class UserController extends AbstractController<Object, Long> {
   ...
   *
   * @RequestHeader(required = false) Integer size, @RequestHeader(required =
   * false) Long foundationId,
   *
   * @RequestHeader(required = false) Long organizationId, @RequestHeader(required
   * = false) UserType type,
   *
   ...
   *
   * @RequestHeader(required = false, defaultValue = "ASCENDING") SortDirection
   * sortDirection,
   *
   ...
   * // hidden = true
   * // )
   * public ResponseModel getCloudUsers(@RequestHeader(required = false) Integer
   * page,
   *
   * @RequestHeader(required = false) Integer size, HttpServletRequest request) {
   * return
   * userAdministrationService.getCloudUsers(PageRequestModel.getPageRequestModel(
   * page, size));
   * }
   *
   ...
   *
   * @Deprecated
   * public ResponseModel getSystemAdmins(@RequestHeader(required = false) Integer
   * page,
   *
   * @RequestHeader(required = false) Integer size, HttpServletRequest request) {
   * return userAdministrationService.getSystemAdmins(PageRequestModel.
   * getPageRequestModel(page, size));
   * }
   *
   ...
   * public ResponseModel resetPassword(@PathVariable Long id, HttpServletRequest
   * request) {
  ...
  // @ApiOperation(value = "Get User Info", notes = "this method is used to get
  // user infromation")
   ...
   * // @ApiOperation(value = "Activate User", notes =
   * "this method is used to activate user")
   * public ResponseModel activateUser(@PathVariable Long id, HttpServletRequest
   * request) {
   ...
   * public ResponseModel createUser(@RequestBody @Validated
   * UserOrganizationCreateModel createModel,
   ...
   * public ResponseModel updateUser(@RequestBody UserOrganizationCreateModel
   * updateModel, @PathVariable Long id,
   * HttpServletRequest request) {
   ...
   * public ResponseModel delete(@PathVariable Long id, HttpServletRequest
   * request) {
  ...
  // @ApiOperation(value = "Search", notes = "this method is used to search
  // users")
  public ResponseModel search(
      @RequestBody UserSearchModel userSearchModel, HttpServletRequest request) {
