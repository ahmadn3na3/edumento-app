...
public class Task {
  ...
  @Indexed private String userName = SecurityUtils.getCurrentUserLogin();
  ...
  public Task(Content contentModel) {
    ...
    this.fileName = contentModel.getFileName();
    this.spaceId = contentModel.getSpace().getId();
    this.ext = contentModel.getExt().toLowerCase();
    this.contentLength = contentModel.getSize();
    this.folderName = contentModel.getFolderName();
    this.contentType = contentModel.getType();
  }
  ...
  public Task(Content contentModel, String viewFolderName, String viewfileName) {
    ...
    this.type = TaskType.VEIW;
    this.status = TaskStatus.OPEN;
    this.key = contentModel.getKey();
    this.keyId = contentModel.getKeyId();
  }
