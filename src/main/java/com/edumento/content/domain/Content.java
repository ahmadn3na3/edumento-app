...
public class Content extends AbstractEntity {
	...
	@Column
	@Enumerated
	private ContentStatus status = ContentStatus.NOT_UPLOAD;
	...
	@Column
	private String thumbResource;
	@Column
	private Boolean allowUseOrginal = Boolean.FALSE;
	@Column
	...
	public boolean equals(Object o) {
		...
		if (!id.equals(content.id) || !Objects.equals(name, content.name) || !shelfName.equals(content.shelfName)
	...
	public int hashCode() {
		...
		return 31 * result + (space != null ? space.hashCode() : 0);
	}
}
