...
public class ContentModel extends ContentCreateModel {
	...
	public String toString() {
		return "ContentModel{" + "id=" + id + ", favorite=" + favorite + ", favoriteDate=" + favoriteDate
				+ ", fileName='" + fileName + '\'' + ", lastAccess=" + lastAccess + ", newContent=" + newContent
				+ ", status=" + status + ", newAnnotation=" + newAnnotation + ", owner=" + owner + ", creator="
				+ creator + ", lastModifiedDate=" + lastModifiedDate + ", creationDate=" + creationDate + "} "
				+ super.toString();
	}
}
