...
public class UploadContentController {
  ...
  // @ApiOperation(value = "Resume Upload", notes = "this method is used to resume upload task")
  public ResponseModel resume(
      @RequestBody MultipartFile file,
      @RequestHeader(name = "uid") String uploadId,
  ...
  // @ApiOperation(value = "Commit", notes = "this method is used to Commit upload task")
  ...
  // @ApiOperation(value = "cancel Upload", notes = "this method is used to cancel upload task")
