...
public class ContentViewController {
	...
	// )
	public ResponseModel viewContent(@PathVariable Long id,
			@RequestHeader(name = "original", required = false) boolean getOrginal) throws IOException {
	...
	// )
	public ResponseModel android(@PathVariable Long id,
			@RequestHeader(name = "original", required = false) boolean getOrginal) throws IOException {
