...
public class MintInteractiveContentConverter {
  ...
  private String getNewVideoHTML(
    ...
    if (NEW_VIDEO_TAG == null) {
      NEW_VIDEO_TAG =
          FileUtils.readFileToString(new File("/data/resources/app/NewVideoElement.html"), "utf-8");
    }
  ...
  public Path convertInteractiveContentDirectorySync(Task task)
    ...
    final var htmlFiles =
        (List<File>) FileUtils.listFiles(interactiveDirectory, new String[] {"html", "htm"}, true);
    // ----------------------
