...
public class Joined extends AbstractEntity {
  ...
  @Column private Boolean favorite = Boolean.FALSE;
  ...
  @Enumerated private SpaceRole spaceRole = SpaceRole.COLLABORATOR;
  @Enumerated private JoinedStatus joinedStatus = JoinedStatus.JOINED;

  @Column private Boolean notification = true;
  @Column private Integer discussionsCount = 0;
  @Column private Integer annotationsCount = 0;
  @Column private Integer assessmentCount = 0;
  @Column private Integer addContentCount = 0;
  @Column private Integer discussionCommentsCount = 0;
  @Column private Integer spaceViewsCount = 0;
  ...
  @Column private Float spaceScorePoints = 0.0f;
