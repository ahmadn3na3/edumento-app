...
public class SpaceCreateModel {
  ...
  public String toString() {
    return String.format(
        "SpaceCreateModel{color='%s', name='%s', tags=%s, price=%s, paid=%s, isPrivate=%s,"
            + " image='%s', thumbnail='%s', description='%s', joinRequestsAllowed=%s,"
            + " autoWifiSyncAllowed=%s, showCommunity=%s, allowRecommendation=%s, ownerId=%d,"
            + " creationDate=%s}",
        color,
        name,
        tags,
