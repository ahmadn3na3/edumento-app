...
public class SpaceListingModel {
	...
	public SpaceListingModel(String url) {
		...
		thumbnail = url + "/img/default/bitmap.png";
	}
	...
	public String toString() {
		return "SpaceListingModel{" + "id=" + id + ", color='" + color + '\'' + ", image='" + image + '\''
				...
				+ ", autoWifiSyncAllowed=" + autoWifiSyncAllowed + ", showCommunity=" + showCommunity
				+ ", allowRecommendation=" + allowRecommendation + ", tags=" + tags + ", creationDate=" + creationDate
				+ ", lastModified=" + lastModified + ", lastAccessed=" + lastAccessed + ", community=" + community
