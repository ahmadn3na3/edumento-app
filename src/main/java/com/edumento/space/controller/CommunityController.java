...
public class CommunityController {
  ...
  //  @ApiOperation(value = "Toggle follow", notes = "this method is used to follow and unfollow
  // user")
  ...
  //  @ApiOperation(value = "Search Community", notes = "this method is used to list users to
  // share")
