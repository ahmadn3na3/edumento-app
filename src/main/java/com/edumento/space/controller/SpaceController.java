...
public class SpaceController extends AbstractController<SpaceCreateModel, Long> {
	...
	// @ApiOperation(value = "Create new space", notes = "this method is used to
	// create a new space
	// for logged in user")
	...
	// @ApiOperation(value = "Check Space Name", notes = "this method is used to
	// check if space name
	// is not duplicated")
	...
	// @ApiOperation(value = "Delete space", notes = "this method is used to delete
	// space , it
	...
	// @ApiOperation(value = "Update space", notes = "this method is used to update
	// space data")
	public ResponseModel update(@PathVariable("id") Long id, @RequestBody SpaceCreateModel spaceCreateModel) {
		return spaceService.updateSpace(id, spaceCreateModel);
	}

	@RequestMapping(path = "/favorite", method = RequestMethod.POST)
	// @ApiOperation(value = "Set Space as favorite", notes = "this method is used
	// to set space as
	// favorit")
	...
	// @ApiOperation(value = "Set Space as not favorite", notes = "this method is
	...
	// @ApiOperation(value = "Rate Space", notes = "this method is used to rate
	// space from 1 to 5")
	...
	// @ApiOperation(value = "Search for Space", notes = "this method is used to
	// search in spaces for
	// a space ")
	public PageResponseModel searchForSpace(@RequestBody SimpleModel name,
		...
		var pageRequestModel = PageRequestModel.getPageRequestModel(page, size, sort);
	...
	// @ApiOperation(value = "get favorite spaces for user", response =
	// SpaceListingModel.class)
	public ResponseModel getFavoriteSpaces(@RequestHeader(required = false, defaultValue = "en") String lang,
			@RequestHeader(required = false) Integer page, @RequestHeader(required = false) Integer size,
			@RequestHeader(required = false) SortField field,
			@RequestHeader(required = false) Sort.Direction direction) {
	...
	// @ApiOperation(value = "get owned spaces", notes = "Get spaces owned by logged
	// in user",
	// response = SpaceListingModel.class)
	public ResponseModel getOwnedSpace(@RequestHeader(required = false, defaultValue = "en") String lang,
			@RequestHeader(required = false) Integer page, @RequestHeader(required = false) Integer size,
			@RequestHeader(required = false) SortField field,
			@RequestHeader(required = false) Sort.Direction direction) {
	...
	// @ApiOperation(value = "get recent access spaces", notes = "this method is
	// used to get the
	// recent spaceses accessed by user", response = SpaceListingModel.class)
	public ResponseModel getRecentAccessedSpaces(@RequestHeader(required = false, defaultValue = "en") String lang) {
		return spaceService.getRecentAccessedSpaces(lang);
	}

	@RequestMapping(method = RequestMethod.GET)
	// @ApiOperation(value = "get all user's spaces", notes = "this method is used
	// to list all spaces
	// that user joined and owned", response = SpaceListingModel.class)
	public ResponseModel get(@RequestHeader(required = false, defaultValue = "en") String lang,
			@RequestHeader(required = false) Integer page, @RequestHeader(required = false) Integer size,
			@RequestHeader(required = false) SortField field,
			@RequestHeader(required = false) Sort.Direction direction) {
	...
	public ResponseModel get(@PathVariable String name,
			@RequestHeader(required = false, defaultValue = "en") String lang,
			@RequestHeader(required = false) Integer page, @RequestHeader(required = false) Integer size,
			@RequestHeader(required = false) SortField field,
			@RequestHeader(required = false) Sort.Direction direction) {
	...
	// @ApiOperation(value = "get all cloud user's spaces ", notes = "this method is
	// used to list
	...
	public ResponseModel get(@PathVariable Long id, @RequestHeader(required = false, defaultValue = "en") String lang) {
		return spaceService.getSpaceById(id, lang);
	}

	@RequestMapping(path = "/{id}/users", method = RequestMethod.GET)
	// @ApiOperation(value = "get spaces users ", notes = "this method is used to
	// list all users in a
	// given space ")
	...
	public ResponseModel getSpaceUpdates(@RequestBody @Validated DateModel dateModel) {
		return spaceService.getSpaceUpdates(ZonedDateTime.ofInstant(dateModel.getDate().toInstant(), ZoneOffset.UTC));
	}

	@RequestMapping(path = "/updateShareRole", method = RequestMethod.PUT)
	// @ApiOperation(value = "update space role ", notes = "this method is used to
	// change user role in
	// space")
	public ResponseModel updateShareRole(@RequestBody @Validated SpaceRoleUpdateModel spaceRoleUpdateModel,
			HttpServletRequest request) {
		return spaceService.changeShareRole(spaceRoleUpdateModel.getSpaceId(), spaceRoleUpdateModel.getUserId(),
				spaceRoleUpdateModel.getSpaceRole());
	}

	@RequestMapping(path = "/{id}/duplicate", method = RequestMethod.GET)
	// @ApiOperation(value = "Duplicate space ", notes = "this method is used to
	// duplicate space")
	...
	// @ApiOperation(value = "join space", notes = "this method is used to let user
	// join a space")
	...
	// @ApiOperation(value = "Leave space", notes = "this method is used to let user
	// leave space")
	...
	// @ApiOperation(value = "update last access", notes = "this method is used to
	// update user's last
	// access to a space")
	...
	// @ApiOperation(value = "autoJoin Users", notes = "this method is used to auto
	// join spaces with
	// tags ")
	public ResponseModel autoJoin(@RequestBody List<String> tags,
			@RequestHeader(required = false) boolean closeAutoLogin) {
