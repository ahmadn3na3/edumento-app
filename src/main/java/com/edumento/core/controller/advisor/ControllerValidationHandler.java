...
public class ControllerValidationHandler {
  ...
  public ResponseModel processExistException(HttpServletRequest request, ExistException e) {
    ResponseModel responseModel = handleMintException(request, e);
  ...
  public ResponseModel processMethodNotSupportedException(
  ...
  private ResponseModel handleMintException(HttpServletRequest request, MintException e) {
    ...
    String langKey = "en";
    if (request != null
        && request.getHeader("lang") != null
        && !request.getHeader("lang").isEmpty()) {
      langKey = request.getHeader("lang");
    }
    Locale currentLocale = Locale.forLanguageTag(langKey);
    if (e.getErrorMessage() != null) {
      msg =
          msgSource.getMessage(
              e.getErrorMessage(), new Object[0], e.getErrorMessage(), currentLocale);
    }
  ...
  private ResponseModel processFieldError(FieldError error) {
    ...
    String msg;
    if (error != null) {
      Locale currentLocale = Locale.forLanguageTag("en");
