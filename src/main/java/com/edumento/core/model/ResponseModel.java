...
public class ResponseModel {
	...
	public static ResponseModel done(Object data) {
		var responseModel = new ResponseModel(data);
	...
	public String toString() {
		return new ToStringCreator(this).append("codeType", codeType).append("code", code).append("message", message)
				.append("data", data).append("messageData", messageData).append("dateTime", dateTime).toString();
	}
}
