...
public class BaseNotificationMessage {
	...
	public BaseNotificationMessage(ZonedDateTime date, int notificationCategory, From from, Target target) {
		this.date = date;
	...
	public boolean equals(Object o) {
		...
		var that = (BaseNotificationMessage) o;

		if (notificationCategory != that.notificationCategory || !Objects.equals(date, that.date)
	...
	@Override
	public int hashCode() {
		var result = date != null ? date.hashCode() : 0;
	...
	public String toString() {
		return "BaseNotificationMessage{" + "date=" + date + ", notificationCategory=" + notificationCategory
