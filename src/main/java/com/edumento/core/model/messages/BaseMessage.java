...
public class BaseMessage {
	...
	public BaseMessage(EntityAction entityAction, Object entityId, String userName, String dataModel) {
	...
	public String toString() {
		return "BaseMessage{" + "entityAction=" + entityAction + ", entityId=" + entityId + ", userName='" + userName
				+ '\'' + ", dataModel=" + dataModel + '}';
	}
}
