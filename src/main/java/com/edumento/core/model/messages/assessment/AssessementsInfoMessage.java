...
public class AssessementsInfoMessage extends SimpleModel {
	...
	public AssessementsInfoMessage(Long id, String name, AssessmentType assessmentType, From from, Long spaceId,
			Date startDateTime, Date dueDateTime, String spaceName, String categoryName, Long challengeeId) {
		super(id, name);
	...
	public String toString() {
		return String.format(
				...
				assessmentType, from, spaceId, startDateTime, dueDateTime, spaceName, categoryName) + super.toString();
	}
