...
public class SpaceShareInfoMessage extends SpaceInfoMessage {
	...
	public SpaceShareInfoMessage(Long id, String name, String image, From from, String catgoryName,
			String catgoryNameAR, Boolean isPrivate, Set<Long> userIds, String chatId) {
