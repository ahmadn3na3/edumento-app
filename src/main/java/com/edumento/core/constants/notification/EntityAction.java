...
public enum EntityAction {
  ...
  SPACE_DELETE(EntityType.SPACE, Actions.DELETE, Long.class),
  SPACE_RATE(EntityType.SPACE, Actions.RATE, Long.class),
  ...
  USER_UPDATE(EntityType.USER, Actions.UPDATE, Long.class),
  USER_DELETE(EntityType.USER, Actions.DELETE, Long.class),
  USER_FOLLOW(EntityType.USER, Actions.FOLLOW, UserFollowMessage.class),
  USER_BLOCK(EntityType.USER, Actions.BLOCK, Long.class),
  ROLE_UPDATE(EntityType.ROLE, Actions.UPDATE, Long.class),
  ROLE_CREATE(EntityType.ROLE, Actions.CREATE, Long.class),
  ROLE_DELETE(EntityType.ROLE, Actions.DELETE, Long.class),
