...
public class AuditingAspect {
  ...
  @Autowired SpringSecurityAuditorAware securityAuditorAware;
  ...
  public void logBeforeAuditActivityBefore(JoinPoint jp, Auditable auditable) {
    ...
    var auditMessage =
        new AuditMessage(
            currentUserDetail != null ? currentUserDetail.getId() : null,
            currentUserDetail != null ? currentUserDetail.getUsername() : null,
            auditable.value(),
            dataMap);
    auditMessage.setClientId(
        currentUserDetail != null ? currentUserDetail.getCurrentClientId() : null);
