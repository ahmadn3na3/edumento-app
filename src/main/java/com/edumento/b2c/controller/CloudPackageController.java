...
//  )
	public ResponseModel update(@PathVariable Long id, @RequestBody CloudPackageCreateModel cloudPackageCreateModel) {
...
//  )
	public ResponseModel assign(@PathVariable Long id, @RequestBody(required = true) List<Long> users) {
...
//  )
	public ResponseModel unassign(@PathVariable Long id, @RequestBody(required = true) List<Long> users) {
