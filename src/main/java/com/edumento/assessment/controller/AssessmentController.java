...
public class AssessmentController extends AbstractController<AssessmentCreateModel, Long> {
  ...
  //	@ApiOperation(value = "Create Assessment ", notes = "this method is used to create assessment
  // assignment , quize , worksheet and practice")
  ...
  //	@ApiOperation(value = "Generate practice", notes = "this method is used to generate practice
  // from question bank")
  public ResponseModel generatePratcice(
      @RequestBody @Validated PracticeGenerateModel practiceGenerateModel,
  ...
  //	@ApiOperation(value = "Generate challenge", notes = "this method is used to generate practice
  // from question bank")
  public ResponseModel generateChanllenge(
      @RequestBody @Validated ChallengeCreateModel challengeCreateModel,
      HttpServletRequest request) {
  ...
  public ResponseModel update(
      @PathVariable Long id, @RequestBody @Validated AssessmentCreateModel updateModel) {
  ...
  //	@ApiOperation(value = "Get user challenges", notes = "this method is used to get user
  // challenges ")
  public ResponseModel getUserChallenges(
      @PathVariable Long spaceId,
      @RequestHeader(required = false) Integer page,
      @RequestHeader(required = false) Integer size) {
    return assessmentService.getUserChallenges(
        spaceId, PageRequestModel.getPageRequestModel(page, size));
  }

  /** Created by A.Alsayed on 05/01/19. */
  @RequestMapping(path = "/challenge/{challengeId}/start", method = RequestMethod.GET)
  //	@ApiOperation(value = "start user challenges", notes = "this method is used to start user
  // challenge")
  ...
  //	@ApiOperation(value = "Get challenge opponent", notes = "this method is used to get challenge
  // opponents")
  ...
  //	@ApiOperation(value = "testing check assessment", notes = "this method is testing check
  // assessment")
  ...
  //	@ApiOperation(value = "Get an assessment", notes = "this method is used to get an assessment by
  // id")
  ...
  //	@ApiOperation(value = "List all assessment", notes = "this method is used to get all
  // assessments for user")
  public ResponseModel getAll(
      @RequestBody @Validated AssessmentGetAllModel assessmentGetAllModel,
      @RequestHeader(required = false) Integer page,
      @RequestHeader(required = false) Integer size,
    ...
    return assessmentService.get(
        assessmentGetAllModel, PageRequestModel.getPageRequestModel(page, size, sort));
  }

  @RequestMapping(path = "/assessmentOverview/{spaceId}", method = RequestMethod.GET)
  //	@ApiOperation(value = "Get assessment overview", notes = "this method is used to get an
  // overview of assessments in specific space")
  ...
  //	@ApiOperation(value = "Get All Assessments", notes = "this method is used to get all
  // Assessments", hidden = true)
  public ResponseModel getAll(
      @RequestHeader(required = false) Long spaceId,
      @RequestHeader(required = false) AssessmentType assessmentType,
      @RequestHeader(required = false) Integer page,
      @RequestHeader(required = false) Integer size) {
    return assessmentService.getAll(
        PageRequestModel.getPageRequestModel(page, size), spaceId, assessmentType);
  }

  @Override
  @DeleteMapping(path = "/{id}")
  //	@ApiOperation(value = "Delete assessment", notes = "this method is used to delete assessment by
  // id")
  public ResponseModel delete(@PathVariable Long id) {
    return assessmentService.delete(id);
  }

  //	@ApiOperation(value = "Submit assessment", notes = "this method is used to submit user answers
  // for an assessment")
  @RequestMapping(path = "/submit", method = RequestMethod.POST)
  public ResponseModel submit(
      @RequestBody @Validated UserAssessmentModel userAssessmentModel,
  ...
  @Deprecated
  public ResponseModel getUpdates(
      @RequestBody @Validated AssessmentGetAllModel assessmentGetAllModel) {
    return assessmentService.getUpdates(assessmentGetAllModel);
  }

  @RequestMapping(path = "/getComunityList/{id}", method = RequestMethod.GET)
  //	@ApiOperation(value = "Get assessment's community", notes = "this method is used to list users
  // who answer an assessment")
  ...
  //	@ApiOperation(value = "Publish assessment", notes = "this method is used to publish an
  // assessment")
  ...
  //	@ApiOperation(value = "Get User's assessment", notes = "this method is used to get specific
  // assessment of specific user")
  ...
  //	@ApiOperation(value = "Update assessment status", notes = "this method is used to update
  // assessment status", hidden = true)
  public ResponseModel updateAssessmentStatus(
      @PathVariable Long id, @PathVariable AssessmentStatus status) {
  ...
  //	@ApiOperation(value = "Submit question", notes = "this method is used to submit question",
  // hidden = true)
