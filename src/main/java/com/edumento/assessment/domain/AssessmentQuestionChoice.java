...
public class AssessmentQuestionChoice extends AbstractEntity {
	...
	@JoinColumn(name = "assessment_question", nullable = false, foreignKey = @ForeignKey(name = "FK_ASSESSMENT_QUESTION"))
	...
	public String toString() {
		return "AssessmentQuestionChoice{" + "id=" + id + ", assessmentQuestion=" + assessmentQuestion + ", label='"
				+ label + '\'' + ", correctAnswer=" + correctAnswer + ", correctOrder=" + correctOrder
				+ ", correctAnswerResourceUrl='" + correctAnswerResourceUrl + '\'' + ", pairCol=" + pairCol + "} "
				+ super.toString();
	}
}
