...
public class AssessmentCreateModel {
	...
	public AssessmentCreateModel(String title, AssessmentType assessmentType, boolean publish, Long spaceId,
	...
	public String toString() {
		return "AssessmentCreateModel{" + "title='" + title + '\'' + ", dueDate=" + dueDate + ", assessmentType="
				+ assessmentType + ", lockMint=" + lockMint + ", limitDuration=" + limitDuration + ", startDate="
				+ startDate + ", dateOnly=" + dateOnly + ", randomizingQuestion=" + randomizingQuestion
				+ ", viewAnswersAfterSubmit=" + viewAnswersAfterSubmit + ", publish=" + publish + ", spaceId=" + spaceId
				+ '}';
	}
}
