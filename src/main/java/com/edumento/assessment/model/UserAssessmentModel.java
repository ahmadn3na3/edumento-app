...
public class UserAssessmentModel {
	...
	public String toString() {
		return "UserAssessmentModel{" + "userId='" + userId + '\'' + ", assessmentId=" + assessmentId
				+ ", assessmentStatus=" + assessmentStatus + ", questionAnswerModels=" + questionAnswerModels
				+ ", totalGrade=" + totalGrade + ", fullGrade=" + fullGrade + ", bestAnswer=" + bestAnswer
				+ ", topThree=" + topThree + '}';
	}
}
