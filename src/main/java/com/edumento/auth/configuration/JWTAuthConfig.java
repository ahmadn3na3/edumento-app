...
import com.edumento.auth.converter.CustomJwtConveter;
...
public class JWTAuthConfig {
  ...
  public SecurityFilterChain standardSecurityFilterChain(
      HttpSecurity http, JwtDecoder jwtDecoder, MvcRequestMatcher.Builder mvc) throws Exception {
                        ...
                        csp ->
                            csp.policyDirectives(
                                "default-src 'self'; frame-src 'self' data:; script-src 'self'"
                                    ...
                                    + " https://storage.googleapis.com; style-src 'self'"
                                    + " https://fonts.googleapis.com 'unsafe-inline'; img-src"
                                    + " 'self' data:; font-src 'self' https://fonts.gstatic.com"
                                    + " data:"))
        ...
        .authorizeHttpRequests(
            authz ->
                authz
                    ...
                    .authenticated()
                    .requestMatchers(mvc.pattern("/upload/**"))
                    .permitAll()
  ...
  @Bean
  public CustomJwtConveter jwtAuthenticationConverter() {
    var grantedAuthoritiesConverter = new JwtGrantedAuthoritiesConverter();
    grantedAuthoritiesConverter.setAuthorityPrefix("");
    grantedAuthoritiesConverter.setAuthoritiesClaimName(AUTHORITIES_KEY);
    var jwtAuthenticationConverter = new CustomJwtConveter();
