...
public interface NotificationRepository extends MongoRepository<Notification, String> {
  Stream<Notification> findByUserIdAndReceivedFalseAndDeletedFalseOrderByCreationDateDesc(
      Long userid);
  ...
  Stream<Notification> findByIdInAndUserIdAndDeletedFalseOrderByCreationDateDesc(
      List<String> id, Long userId);

  Optional<Long> countByUserIdAndReceivedFalseAndDeletedFalseAndNotificationCategoryEquals(
      Long userId, int i);
}
