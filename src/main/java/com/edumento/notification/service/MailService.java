...
public class MailService {
  ...
  @Autowired
  public MailService(
      MessageSource messageSource, SpringTemplateEngine templateEngine, SendGrid sendGrid) {
  ...
  public void sendEmail(
      String from, String to, String subject, String content, boolean isMultipart, boolean isHtml) {
    log.debug(
  ...
  public void sendActivationEmail(UserInfoMessage user) {
    ...
    var subject =
        messageSource.getMessage(
            emailEnvName + " " + "email.creation.title",
            null,
            emailEnvName + " user creation",
            locale);
  ...
  public void sendCreationEmail(UserInfoMessage user) {
    ...
    var subject =
        messageSource.getMessage(
            emailEnvName + " " + "email.activation.title",
            null,
            emailEnvName + " Activation Mail",
            locale);
  ...
  public void sendPasswordResetMail(UserInfoMessage user) {
    ...
    var subject =
        messageSource.getMessage(
            emailEnvName + " " + "email.reset.title",
            null,
            emailEnvName + " Reset Passeword Mail",
            locale);
