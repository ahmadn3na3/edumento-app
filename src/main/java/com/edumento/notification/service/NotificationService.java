...
public class NotificationService {
            ...
            new Function<User, ResponseModel>() {
              ...
              public ResponseModel apply(User user) {
                notificationRepository
                    .findByIdInAndUserIdAndReceivedFalseAndDeletedFalseOrderByCreationDateDesc(
  ...
  public ResponseModel getMyNotifications(boolean seen) {
    ...
    List<NotificationMessage> notificationMessages =
        notificationRepository
            ...
            .map(
                new Function<Notification, NotificationMessage>() {
                  @Override
  ...
  public ResponseModel getMyNotificationsCount() {
    return ResponseModel.done(
        notificationRepository
            .countByUserIdAndReceivedFalseAndDeletedFalseAndNotificationCategoryEquals(
                SecurityUtils.getCurrentUser().getId(), MessageCategory.USER)
            .get());
  }
  ...
  public ResponseModel seen(String... id) {
    return ResponseModel.done(
        notificationRepository
            .findByIdInAndUserIdAndDeletedFalseOrderByCreationDateDesc(
