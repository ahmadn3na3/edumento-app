...
public class AssessmentNotificationHandler extends AbstractHandler {
    ...
    switch (assessementsInfoMessage.getAssessmentType()) {
      ...
      case CHALLENGE:
        ...
        var infoMessage =
            new UserInfoMessage(
                userRepository
                    .findById(assessementsInfoMessage.getChallengeeId())
        ...
        var notificationMessage =
            amqNotifier.saveMessage(
                ...
                message,
                null,
                assessementsInfoMessage.getFrom().getName(),
                assessementsInfoMessage.getSpaceName(),
                String.format(
                    "%1$td/%1$tm/%1$tY %1$tr %1$tZ", assessementsInfoMessage.getDueDateTime()));
  ...
  private void onCreateSendMessage(
