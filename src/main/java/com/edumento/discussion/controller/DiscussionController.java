...
public class DiscussionController extends AbstractController<DiscussionCreateModel, String> {
  ...
  //	@ApiOperation(value = "Create Discussion", notes = "this method is used to create new
  // discussion")
  ...
  //	@ApiOperation(value = "update discussion", notes = "this method is used to update discussion",
  // hidden = false)
  ...
  //	@ApiOperation(value = "List Discussions", notes = "this method is used to list all discussion
  // on a space")
  public ResponseModel listAllDiscussion(
    ...
    return discussionService.getAllDiscussions(
        ...
        PageRequestModel.getPageRequestModel(
            page, size, Sort.by(Sort.Direction.DESC, "creationDate")));
  }

  @GetMapping("/listAllInquiry/{spaceId}")
  //	@ApiOperation(value = "List Inquiries", notes = "this method is used to list all discussion on
  // a space")
  public ResponseModel listAllInquiry(
      @PathVariable("spaceId") Long spaceId,
      @RequestHeader(required = false) Integer page,
      @RequestHeader(required = false) Integer size) {
    ...
    return discussionService.getAllDiscussions(
        ...
        PageRequestModel.getPageRequestModel(
            page, size, Sort.by(Sort.Direction.DESC, "modificationDate")));
  }
  ...
  //	@ApiOperation(value = "Comment on discussion", notes = "this method is used to add comment on
  // discussion")
  public ResponseModel reply(
      @PathVariable("id") String id,
  ...
  //	@ApiOperation(value = "Delete Comment", notes = "this method is used to delete comment from
  // discussion")
  ...
  //	@ApiOperation(value = "Edit Comment", notes = "this method is used to edit comment on
  // discussion")
  public ResponseModel editReply(
      @PathVariable("id") String id, @RequestBody CommentCreateModel body) {
  ...
  public ResponseModel getUpdates(
      @PathVariable("spaceId") Long spaceId, @RequestBody @Validated DateModel since) {
    return discussionService.getUpdates(
        spaceId, DateConverter.convertZonedDateTimeToDate(since.getDate()));
  }
