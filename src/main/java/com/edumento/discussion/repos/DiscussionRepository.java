...
public interface DiscussionRepository extends MongoRepository<Discussion, String> {
  ...
  Page<Discussion> findBySpaceIdAndTypeAndDeletedFalseOrderByCreationDateDesc(
      Long spaceId, DiscussionType type, Pageable pageRequest);
  ...
  Integer countBySpaceIdAndTypeAndOwnerIdAndDeletedFalse(
      Long SpaceId, DiscussionType typr, Long ownerId);
}
