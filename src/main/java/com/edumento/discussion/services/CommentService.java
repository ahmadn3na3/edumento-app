...
public class CommentService {
  ...
  public Comment createComment(
      String id, User user, CommentCreateModel commentCreateModel, CommentType type, Long spaceId) {
            ...
            new Consumer<User>() {
              ...
              public void accept(User user) {
                ...
                if (list != null && !list.isEmpty()) {
                  likeRepository.deleteByParentIdIn(
                      list.stream().map(Comment::getParentId).collect(Collectors.toSet()));
                }
              }
            });
  }
            ...
            new Function<Comment, ResponseModel>() {
              ...
              public ResponseModel apply(Comment comment) {
                return likeRepository
                    .findOneByUserIdAndParentIdAndDeletedFalse(user.getId(), comment.getId())
                    .map(
                        new Function<Like, ResponseModel>() {
                          @Override
