...
public class CommentViewModel {
	...
	public String toString() {
		return "CommentViewModel{" + "id='" + id + '\'' + ", commentBody='" + commentBody + '\'' + ", userId=" + userId
				+ ", userName='" + userName + '\'' + ", userImage='" + userImage + '\'' + ", userFullname='"
				+ userFullname + '\'' + ", likeEnabled=" + likeEnabled + ", creationDate=" + creationDate
				+ ", lastModifiedDate=" + lastModifiedDate + ", likes=" + likes + '}';
	}
}
