...
public class TimeLock extends AbstractEntity {
	...
	@CollectionTable(name = "lock_days", joinColumns = @JoinColumn(name = "time_lock"), foreignKey = @ForeignKey(name = "FK_TIME_LOCK_WEEK_DAY"))
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, name, organization, toDate);
	}
