...
public class FoundationPackageController extends AbstractController<FoundationPackageCreateModel, Long> {
	@Autowired
	...
	// )
	public ResponseModel create(@RequestBody FoundationPackageCreateModel foundationPackageCreateModel) {
	...
	// )
	public ResponseModel assign(@PathVariable Long id, @RequestBody(required = true) List<Long> foundationIds) {
	...
	// )
	public ResponseModel unassign(@PathVariable Long id, @RequestBody(required = true) List<Long> foundationIds) {
