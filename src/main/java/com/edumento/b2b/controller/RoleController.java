...
public class RoleController extends AbstractController<RoleCreateModel, Long> {
	...
	// @ApiOperation(value = "Create Role", notes = "this method is used to create
	// role")
	...
	// @ApiOperation(value = "Update Role", notes = "this method is used to update
	// role by id")
	public ResponseModel update(@PathVariable("id") Long id, @RequestBody @Validated RoleCreateModel roleCreateModel) {
		return roleService.updateRole(id, roleCreateModel);
	}

	@Override
	@RequestMapping(path = "/{id}", method = RequestMethod.GET)
	// @ApiOperation(value = "Get Role", notes = "this method is used to get role by
	// id")
	...
	// @ApiOperation(value = "Get users", notes = "this method is used to get users
	// on role by id")
	...
	// @ApiOperation(value = "Delete Role", notes = "this method is used to delete
	// role by id")
	...
	// @ApiOperation(value = "Delete Roles", notes = "this method is used to delete
	// a list of roles")
	...
	// @ApiOperation(value = "Get Roles", notes = "this method is used to get
	// current user roles")
	...
	// @ApiOperation(value = "Assign", notes = "this method is used to Assign Role
	// ", hidden = true)
	...
	// @ApiOperation(
	// value = "Get Role",
	// notes = "this method is used to get role by organization , foundation and
	// user type"
	// )
