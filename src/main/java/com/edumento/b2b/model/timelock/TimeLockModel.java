...
public class TimeLockModel extends TimeLockCreateModel {
  ...
  public String toString() {
    return "TimeLockModel{" + "id=" + id + ", organizationModel=" + organizationModel
        + ", timeLockExceptionCount=" + timeLockExceptionCount + ", timeLockExceptionModels="
        + timeLockExceptionModels + "} " + super.toString();
  }
}
