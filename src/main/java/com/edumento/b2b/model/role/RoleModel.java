...
public class RoleModel extends RoleCreateModel {
	...
	public String toString() {
		return "RoleModel{" + "Id=" + Id + ", organization=" + organization + ", numberOfUsers=" + numberOfUsers
				+ ", creationDate=" + creationDate + ", lastModifiedDate=" + lastModifiedDate + ", lastModifiedBy='"
				+ lastModifiedBy + '\'' + ", createBy='" + createBy + '\'' + ", type=" + type + "} " + super.toString();
	}
}
