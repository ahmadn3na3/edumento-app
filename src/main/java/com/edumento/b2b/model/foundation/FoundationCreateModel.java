...
public class FoundationCreateModel {
  ...
  public String toString() {
    return "FoundationCreateModel{" + "name='" + name + '\'' + ", code='" + code + '\''
        + ", startDate=" + startDate + ", endDate=" + endDate + ", messageEnabled=" + messageEnabled
        + ", marketEnabled=" + marketEnabled + ", timeLockEnabled=" + timeLockEnabled
